...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     ;; FUN
     ;; emoji
     ;; selectric ;; typewrite like sound
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemac-mode-line-theme '(doom :separator wave :separator-scale 1)
...
before packages are loaded."
  ...
  (setq general-config-file (file-truename (concat dotspacemacs-directory "+general-config.el")))
  (load general-config-file)

  ;; Version Control - Magit, Ediff
